...
class Project < ApplicationRecord
    ...
    # url = 'https://api.globalgiving.org/api/public/projectservice/all/projects?api_key=81e83abd-34c8-4ce8-8282-bce16c0fc71c'

    def self.queryActiveProjects(params)
        api_key = '81e83abd-34c8-4ce8-8282-bce16c0fc71c'
        if params[:nextProject]
          url = "https://api.globalgiving.org/api/public/projectservice/all/projects/active?api_key=81e83abd-34c8-4ce8-8282-bce16c0fc71c&nextProjectId=#{params[:nextProject]}&status=active"
        else
          url = "https://api.globalgiving.org/api/public/projectservice/all/projects/active?api_key=81e83abd-34c8-4ce8-8282-bce16c0fc71c&status=active"
        end
      ...
      def self.fetch(params)
        #Add a check to see if Project count < 8000.
